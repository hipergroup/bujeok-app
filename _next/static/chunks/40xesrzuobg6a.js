(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,75811,e=>{e.q("/bujeok-app/_next/static/media/hanji-bg.2qi4n-47_78y8.jpg")},44714,e=>{e.q("/bujeok-app/_next/static/media/wordmark-mark.3urt7e9hv6s_u.png")},61568,64275,e=>{"use strict";var t=e.i(43476);let r={src:e.i(75811).default,width:900,height:1599,blurWidth:5,blurHeight:8,blurDataURL:"data:image/jpeg;base64,"};e.s(["default",0,function({children:e,decorated:o=!1,className:l=""}){return(0,t.jsxs)("div",{className:`hanji-surface relative flex min-h-dvh flex-col text-[var(--color-meok)] ${l}`,children:[(0,t.jsx)("div",{"aria-hidden":!0,className:"pointer-events-none fixed inset-0 z-0",style:{backgroundImage:`url(${r.src})`,backgroundSize:"cover",backgroundPosition:"center top",backgroundRepeat:"no-repeat"}}),(0,t.jsx)("div",{className:"relative z-10 flex min-h-dvh flex-col",children:e})]})}],61568);var o=e.i(57688),l=e.i(59897);let i={src:e.i(44714).default,width:480,height:201,blurWidth:8,blurHeight:3,blurDataURL:"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAgAAAADCAYAAACuyE5IAAAAbklEQVR42gFjAJz/AAQDAQwWDwNXDAgCJhMMAjUVDQM/BQMBEhoRBGUNCQI3ABAKAjsUDQNOEAoCOhMNA0UYEANYDgkCLhkQBGwpFgRUAAMCAA0HBQEcBwQBFgoHASYIBQEaBgQBEg4JAjBMJAVKhh4H61k2XjcAAAAASUVORK5CYII="};e.s(["default",0,function({left:e,right:r,title:n,showSeal:s=!1,wordmark:a=!1}){return(0,t.jsxs)("header",{className:"flex items-center justify-between px-4 pb-3 pt-[max(0.875rem,env(safe-area-inset-top))]",children:[(0,t.jsx)("div",{className:"flex h-10 w-10 items-center justify-center text-[var(--color-meok)]",children:e}),(0,t.jsxs)("div",{className:"flex items-center gap-2",children:[a&&(0,t.jsx)(o.default,{src:i,alt:"수호부",priority:!0,className:"h-16 w-auto"}),!a&&s&&(0,t.jsx)(l.SealLogo,{size:30}),!a&&n&&(0,t.jsx)("h1",{className:"font-serif-kr text-base font-bold tracking-wide text-[var(--color-meok)]",children:n})]}),(0,t.jsx)("div",{className:"flex h-10 w-10 items-center justify-center text-[var(--color-meok)]",children:r})]})}],64275)},88653,e=>{"use strict";e.i(47167);var t=e.i(43476),r=e.i(71645),o=e.i(31178),l=e.i(47414),i=e.i(74008),n=e.i(21476),s=e.i(72846),a=r,c=e.i(37806);function d(e,t){if("function"==typeof e)return e(t);null!=e&&(e.current=t)}class f extends a.Component{getSnapshotBeforeUpdate(e){let t=this.props.childRef.current;if((0,s.isHTMLElement)(t)&&e.isPresent&&!this.props.isPresent&&!1!==this.props.pop){let e=t.offsetParent,r=(0,s.isHTMLElement)(e)&&e.offsetWidth||0,o=(0,s.isHTMLElement)(e)&&e.offsetHeight||0,l=getComputedStyle(t),i=this.props.sizeRef.current;i.height=parseFloat(l.height),i.width=parseFloat(l.width),i.top=t.offsetTop,i.left=t.offsetLeft,i.right=r-i.width-i.left,i.bottom=o-i.height-i.top,i.direction=l.direction}return null}componentDidUpdate(){}render(){return this.props.children}}function h({children:e,isPresent:o,anchorX:l,anchorY:i,root:n,pop:s}){let x=(0,a.useId)(),u=(0,a.useRef)(null),p=(0,a.useRef)({width:0,height:0,top:0,left:0,right:0,bottom:0,direction:"ltr"}),{nonce:g}=(0,a.useContext)(c.MotionConfigContext),k=function(...e){return r.useCallback(function(...e){return t=>{let r=!1,o=e.map(e=>{let o=d(e,t);return r||"function"!=typeof o||(r=!0),o});if(r)return()=>{for(let t=0;t<o.length;t++){let r=o[t];"function"==typeof r?r():d(e[t],null)}}}}(...e),e)}(u,!1!==s?e.props?.ref??e?.ref:void 0);return(0,a.useInsertionEffect)(()=>{let{width:e,height:t,top:r,left:a,right:c,bottom:d,direction:f}=p.current;if(o||!1===s||!u.current||!e||!t)return;let h="rtl"===f,k="left"===l?h?`right: ${c}`:`left: ${a}`:h?`left: ${a}`:`right: ${c}`,m="bottom"===i?`bottom: ${d}`:`top: ${r}`;u.current.dataset.motionPopId=x;let y=document.createElement("style");g&&(y.nonce=g);let w=n??document.head;return w.appendChild(y),y.sheet&&y.sheet.insertRule(`
        ...
        `),()=>{u.current?.removeAttribute("data-motion-pop-id"),w.contains(y)&&w.removeChild(y)}},[o]),(0,t.jsx)(f,{isPresent:o,childRef:u,sizeRef:p,pop:s,children:!1===s?e:a.cloneElement(e,{ref:k})})}let x=({children:e,initial:o,isPresent:s,onExitComplete:a,custom:c,presenceAffectsLayout:d,mode:f,anchorX:x,anchorY:p,root:g})=>{let k=(0,l.useConstant)(u),m=(0,r.useId)(),y=(0,r.useRef)(s),w=(0,r.useRef)(a);(0,i.useIsomorphicLayoutEffect)(()=>{y.current=s,w.current=a});let A=!0,C=(0,r.useMemo)(()=>(A=!1,{id:m,initial:o,isPresent:s,custom:c,onExitComplete:e=>{for(let t of(k.set(e,!0),k.values()))if(!t)return;a&&a()},register:e=>(k.set(e,!1),()=>{k.delete(e),y.current||k.size||w.current?.()})}),[s,k,a]);return d&&A&&(C={...C}),(0,r.useMemo)(()=>{k.forEach((e,t)=>k.set(t,!1))},[s]),r.useEffect(()=>{s||k.size||!a||a()},[s]),e=(0,t.jsx)(h,{pop:"popLayout"===f,isPresent:s,anchorX:x,anchorY:p,root:g,children:e}),(0,t.jsx)(n.PresenceContext.Provider,{value:C,children:e})};function u(){return new Map}var p=e.i(64978);let g=e=>e.key||"";function k(e){let t=[];return r.Children.forEach(e,e=>{(0,r.isValidElement)(e)&&t.push(e)}),t}e.s(["AnimatePresence",0,({children:e,custom:n,initial:s=!0,onExitComplete:a,presenceAffectsLayout:c=!0,mode:d="sync",propagate:f=!1,anchorX:h="left",anchorY:u="top",root:m})=>{let[y,w]=(0,p.usePresence)(f),A=(0,r.useMemo)(()=>k(e),[e]),C=f&&!y?[]:A.map(g),b=(0,r.useRef)(!0),$=(0,r.useRef)(A),E=(0,l.useConstant)(()=>new Map),M=(0,r.useRef)(new Set),[j,v]=(0,r.useState)(A),[F,N]=(0,r.useState)(A);(0,i.useIsomorphicLayoutEffect)(()=>{b.current=!1,$.current=A;for(let e=0;e<F.length;e++){let t=g(F[e]);C.includes(t)?(E.delete(t),M.current.delete(t)):!0!==E.get(t)&&E.set(t,!1)}},[F,C.length,C.join("-")]);let B=[];if(A!==j){let e=[...A];for(let t=0;t<F.length;t++){let r=F[t],o=g(r);C.includes(o)||(e.splice(t,0,r),B.push(r))}return"wait"===d&&B.length&&(e=B),N(k(e)),v(A),null}let{forceRender:D}=(0,r.useContext)(o.LayoutGroupContext);return(0,t.jsx)(t.Fragment,{children:F.map(e=>{let r=g(e),o=(!f||!!y)&&(A===F||C.includes(r));return(0,t.jsx)(x,{isPresent:o,initial:(!b.current||!!s)&&void 0,custom:n,presenceAffectsLayout:c,mode:d,root:m,onExitComplete:o?void 0:()=>{if(M.current.has(r)||!E.has(r))return;M.current.add(r),E.set(r,!0);let e=!0;E.forEach(t=>{t||(e=!1)}),e&&(D?.(),N($.current),f&&w?.(),a&&a())},anchorX:h,anchorY:u,children:e},r)})})}],88653)},21038,e=>{"use strict";var t=e.i(43476),r=e.i(46932);e.s(["default",0,function({children:e,onClick:o,disabled:l=!1,variant:i="primary",className:n=""}){return(0,t.jsxs)(r.motion.button,{whileTap:l?void 0:{scale:.97},onClick:o,disabled:l,className:`relative w-full rounded-lg px-6 py-3.5 font-serif-kr text-base font-bold tracking-wider transition-colors disabled:opacity-50 ${"primary"===i?"bg-[var(--color-juhong)] text-[#F6EDD9] shadow-[0_2px_8px_rgba(167,43,33,0.35)]":"bg-transparent text-[var(--color-galsaek)]"} ${n}`,style:{border:"1px solid rgba(220, 201, 165, 0.9)"},children:[(0,t.jsx)("span",{className:"pointer-events-none absolute inset-[3px] rounded-md",style:{border:"primary"===i?"1px solid rgba(242, 230, 204, 0.45)":"1px solid rgba(122, 74, 52, 0.3)"}}),e]})}])},41481,e=>{"use strict";let t=[{id:"hwangji",label:"한지",swatch:"#F2E6CC",trad:{bg:"#F2E6CC",ink:"#A72B21",text:"#2E2E2E"},modern:{bg1:"#F5EAD5",bg2:"#F5D5C8",ink:"#AA6B3F",accent:"#D4914F"}},{id:"hongji",label:"홍지",swatch:"#B93A32",trad:{bg:"#B93A32",ink:"#F2E6CC",text:"#FFF3D6"},modern:{bg1:"#F5D5D5",bg2:"#F5C8D5",ink:"#A03A3A",accent:"#D46F6F"}},{id:"baekji",label:"백지",swatch:"#F7F3EA",trad:{bg:"#F7F3EA",ink:"#A72B21",text:"#2E2E2E"},modern:{bg1:"#EFEFF5",bg2:"#DDE8F5",ink:"#4F5FAA",accent:"#7A8FD4"}},{id:"simya",label:"심야",swatch:"#151226",trad:{bg:"#151226",ink:"#E8C97A",text:"#D8D4F0"},modern:{bg1:"#1C1830",bg2:"#2A1F42",ink:"#C9B8F0",accent:"#8F7AD4"}},{id:"namsaekji",label:"남색",swatch:"#1F3E63",trad:{bg:"#1F3E63",ink:"#DAA017",text:"#F2E6CC"},modern:{bg1:"#2A4A73",bg2:"#1F3E63",ink:"#E8D9B0",accent:"#DAA017"}},{id:"ssukji",label:"쑥색",swatch:"#6B7D63",trad:{bg:"#6B7D63",ink:"#F2E6CC",text:"#FBF6E8"},modern:{bg1:"#7C8E74",bg2:"#6B7D63",ink:"#F2E6CC",accent:"#DCC9A5"}},{id:"geumji",label:"황금",swatch:"#DAA017",trad:{bg:"#DAA017",ink:"#7A4A34",text:"#3E2A1C"},modern:{bg1:"#E5B23A",bg2:"#DAA017",ink:"#7A4A34",accent:"#A72B21"}}],r=new Set(["hwangji","baekji"]),o=[{bg1:"#E8D5F5",bg2:"#F5D5E8",ink:"#6B3FA0",accent:"#D46FA0"},{bg1:"#D5EEF5",bg2:"#D5F5E8",ink:"#2B7A8A",accent:"#3AAA7A"},{bg1:"#F5EAD5",bg2:"#F5D5D5",ink:"#AA6B3F",accent:"#D46F4F"},{bg1:"#D5D5F5",bg2:"#E8D5F5",ink:"#4F4FAA",accent:"#7A5FD4"},{bg1:"#F5F5D5",bg2:"#E8F5D5",ink:"#6B8A2B",accent:"#8AAA3F"}];function l(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&apos;")}function i(e,t){let r=[],o="";for(let l of e.split(/\s+/).filter(Boolean)){if(l.length>t){o&&(r.push(o),o="");for(let e=0;e<l.length;e+=t){let i=l.slice(e,e+t);i.length===t?r.push(i):o=i}continue}let e=o?`${o} ${l}`:l;e.length>t?(r.push(o),o=l):o=e}return o&&r.push(o),r}let n={쥐:`<g transform="translate(-20,-20) scale(0.8)">
  ...
  </g>`}function a(e,t,r,o){let l=[];for(let o=0;o<5;o++){let i=Math.PI/2+2*o*Math.PI/5,n=i+Math.PI/5;l.push(`${e+r*Math.cos(i)},${t-r*Math.sin(i)}`),l.push(`${e+.4*r*Math.cos(n)},${t-.4*r*Math.sin(n)}`)}return`<polygon points="${l.join(" ")}" fill="none" stroke="${o}" stroke-width="1.5" opacity="0.6"/>`}e.s(["ANIMAL_PATHS",0,n,"generateTalismanSVG",0,function(e){var c;if(e.assetUrl)return function(e){let{assetUrl:t,message:r,userName:o}=e,n="#A72B21",s="#F2E6CC",a=r?i(r,12).slice(0,2):[],c=a.length?26+24*a.length:0,d=560-c-14,f=a.length?`<rect x="18" y="${d}" width="324" height="${c}" rx="6"
         fill="${s}" opacity="0.9"/>
       <rect x="18" y="${d}" width="324" height="${c}" rx="6"
         fill="none" stroke="${n}" stroke-width="1" opacity="0.45"/>`:"",h=a.map((e,t)=>`<text x="168" y="${d+30+24*t}" text-anchor="middle" font-size="17" fill="#2E2E2E" font-family="'Gowun Batang', 'AppleMyungjo', serif">${l(e)}</text>`).join(""),x=o&&o.trim().length>=2&&o.trim().length<=3?o.trim():null,u=x?`<text x="0" y="4" text-anchor="middle" font-size="11" font-weight="bold" fill="${s}" font-family="serif">${l(x)}</text>`:`<text x="0" y="-2" text-anchor="middle" font-size="9.5" font-weight="bold" fill="${s}" font-family="serif">수호</text>
       <text x="0" y="10" text-anchor="middle" font-size="9.5" font-weight="bold" fill="${s}" font-family="serif">부</text>`,p=a.length?`<g transform="translate(314, ${d+c/2})">
         <rect x="-15" y="-15" width="30" height="30" rx="4" fill="${n}"/>
         <rect x="-11.5" y="-11.5" width="23" height="23" rx="3" fill="none" stroke="${s}" stroke-width="1" opacity="0.9"/>
         ${u}
       </g>`:"";return`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 560" preserveAspectRatio="xMidYMid meet">
  <rect width="360" height="560" fill="${s}"/>
  <image href="${l(t??"")}" x="0" y="0" width="360" height="560" preserveAspectRatio="xMidYMid meet"/>
  ${f}
  ${h}
  ${p}
</svg>`}(e);let d=(c=e.background)?t.find(e=>e.id===c):void 0;return"traditional"===e.style?function(e,t){let{bgColor:o,animal:s,title:a,hanja:c,message:d,mantra:f,userName:h}=t,x=e?.trad??{bg:"#F2E6CC",ink:"#A72B21",text:"#2E2E2E"},u=x.bg||o||"#F2E6CC",p=(!e||r.has(e.id))&&t.accent||x.ink,g=x.text,k=`<path d="M0 14V0h14M5 14V5h9" fill="none" stroke="${p}" stroke-width="1.4" opacity="0.55"/>`,m=`
  ...
  `,w="";s&&n[s]&&(w=`<g transform="translate(${180}, 208)" color="${p}" opacity="0.9">${n[s]}</g>`);let A=i(d,7).slice(0,3),C=w?272:248,b="";A.forEach((e,t)=>{let r=180+((A.length-1)/2-t)*38;[...e.replace(/\s+/g,"")].forEach((e,t)=>{b+=`<text x="${r}" y="${C+28*t}" text-anchor="middle" font-size="20" fill="${g}" font-family="'Gowun Batang', 'AppleMyungjo', serif">${l(e)}</text>`})});let $=h&&h.trim().length>=2&&h.trim().length<=3?h.trim():null,E=$?`<text x="0" y="5" text-anchor="middle" font-size="12" font-weight="bold" fill="#F2E6CC" font-family="serif">${l($)}</text>`:`<text x="0" y="-2" text-anchor="middle" font-size="11" font-weight="bold" fill="#F2E6CC" font-family="serif">수호</text>
       <text x="0" y="12" text-anchor="middle" font-size="11" font-weight="bold" fill="#F2E6CC" font-family="serif">부</text>`,M=`
  ...
  ${f?`<text x="${180}" y="${468}" text-anchor="middle" font-size="12" fill="${p}" opacity="0.85" font-family="serif">${l(f)}</text>`:""}

  <!-- 낙관 -->
  ${M}
</svg>`}(d,e):function(e,t,r,c,d,f,h,x){var u,p,g,k,m;let y,w=Math.abs(c.split("").reduce((e,t)=>e+t.charCodeAt(0),0))%o.length,A=o[w],C=e?.modern.bg1||t||A.bg1,b=e?.modern.bg2||A.bg2,$=e?.modern.ink||A.ink,E=e?.modern.accent||A.accent,M="";M+=s(55,90,.7,E),M+=s(305,90,.7,E),x?.includes("별")&&(M+=a(50,140,6,E),M+=a(310,140,6,E),M+=a(120,280,5,E),M+=a(240,280,5,E)),x?.includes("연꽃")&&(M+=(u=180,p=400,`<g transform="translate(${u},${p}) scale(0.8)" opacity="0.7">
    ...
    <ellipse cx="12" cy="0" rx="3" ry="7" fill="none" stroke="${E}" stroke-width="1.5" transform="rotate(45,12,0)"/>
  </g>`)),x?.includes("태극")&&(M+=(g=180,`<g transform="translate(${g},140)">
  ...
  </g>`));let j="";r&&n[r]&&(j=`<g transform="translate(${180}, 210)" color="${$}">${n[r]}</g>`);let v=i(d,14),F="";for(let e=0;e<Math.min(v.length,4);e++)F+=`<text x="${180}" y="${300+28*e}" text-anchor="middle" font-size="16" fill="${$}" font-family="'Apple SD Gothic Neo', 'Noto Sans KR', sans-serif">${l(v[e])}</text>`;let N=h?(k=305,m=500,y=h.length>3?h.slice(0,3):h,`
    <g transform="translate(${k},${m})" opacity="0.85">
      <rect x="-14" y="-14" width="28" height="28" rx="3" fill="none" stroke="${E}" stroke-width="2"/>
      <text x="0" y="3" text-anchor="middle" font-size="12" font-weight="bold" fill="${E}" font-family="serif">${l(y)}</text>
    </g>
  `):"";return`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${360} ${560}" preserveAspectRatio="xMidYMid meet">
  <defs>
  ...
  <!-- 두전 (상단 제목) -->
  <text x="${180}" y="85" text-anchor="middle" font-size="24" font-weight="bold" fill="${$}" font-family="'Apple SD Gothic Neo', 'Noto Sans KR', sans-serif" filter="url(#soft-shadow)">${l(c)}</text>
  ...
  <!-- 각획 (하단 주문) -->
  <text x="${180}" y="${470}" text-anchor="middle" font-size="13" fill="${$}" font-family="'Apple SD Gothic Neo', 'Noto Sans KR', sans-serif" opacity="0.8">${l(f)}</text>
  ...
  <!-- 인장 -->
  ${N}
</svg>`}(d,e.bgColor,e.animal,e.title,e.message,e.mantra,e.userName,e.symbols)}])},38992,e=>{"use strict";var t=e.i(25405);function r(e,t){return"string"!=typeof e?"":e.replace(/<[^>]*>/g,"").replace(/[<>]/g,"").replace(/[\u0000-\u0008\u000B-\u001F\u007F]/g,"").trim().slice(0,t)}e.s(["GIFT_MESSAGE_MAX",0,80,"GIFT_NAME_MAX",0,12,"buildGiftUrl",0,function(e){let t=function(e){let t={v:1,t:e.t,m:r(e.m,80),f:r(e.f,12),c:e.c};var o=new TextEncoder().encode(JSON.stringify(t));let l="";for(let e=0;e<o.length;e++)l+=String.fromCharCode(o[e]);return btoa(l).replace(/\+/g,"-").replace(/\//g,"_").replace(/=+$/,"")}(e),o=window.location.pathname.startsWith("/bujeok-app")?"/bujeok-app":"";return`${window.location.origin}${o}/gift/?d=${t}`},"decodeGift",0,function(e){let o;if(!e||"string"!=typeof e||e.length>2e3)return null;let l=function(e){try{let t=e.replace(/-/g,"+").replace(/_/g,"/")+"=".repeat((4-e.length%4)%4),r=atob(t),o=new Uint8Array(r.length);for(let e=0;e<r.length;e++)o[e]=r.charCodeAt(e);return o}catch{return null}}(e);if(!l)return null;try{o=JSON.parse(new TextDecoder().decode(l))}catch{return null}if(!o||"object"!=typeof o)return null;let i=o;if(1!==i.v||"string"!=typeof i.t)return null;let n=t.TALISMANS.find(e=>e.id===i.t);if(!n)return null;let s="string"!=typeof i.c||Number.isNaN(new Date(i.c).getTime())?"":i.c.slice(0,40);return{v:1,t:n.id,m:r(i.m,80),f:r(i.f,12),c:s}},"giftHash",0,function(e){let t=5381;for(let r=0;r<e.length;r++)t=(t<<5)+t+e.charCodeAt(r)>>>0;return t.toString(36)}])},88223,e=>{"use strict";var t=e.i(43476),r=e.i(71645),o=e.i(18566),l=e.i(46932),i=e.i(88653),n=e.i(25405),s=e.i(38992),a=e.i(41481),c=e.i(61568),d=e.i(64275),f=e.i(21038),h=e.i(59897);function x(){let e=(0,o.useRouter)(),x=(0,o.useSearchParams)().get("d")??"",u=(0,r.useMemo)(()=>(0,s.decodeGift)(x),[x]),p=(0,r.useMemo)(()=>u?n.TALISMANS.find(e=>e.id===u.t)??null:null,[u]),g=(0,r.useMemo)(()=>x?`gift-${(0,s.giftHash)(x)}`:"",[x]),[k,m]=(0,r.useState)("wrapped"),[y,w]=(0,r.useState)(!1),[A,C]=(0,r.useState)(!1),b=(0,r.useMemo)(()=>u&&p?(0,a.generateTalismanSVG)({type:p.id,style:"traditional",background:"hwangji",accent:p.colors[2],title:p.name,hanja:p.hanja,message:u.m,mantra:p.mantra,symbols:[...p.design.patterns,...p.design.symbols]}):"",[u,p]);return(0,r.useEffect)(()=>{if(g)try{JSON.parse(localStorage.getItem("bujeok-collection")||"[]").some(e=>e.id===g)&&C(!0)}catch{}},[g]),(0,t.jsxs)(c.default,{children:[(0,t.jsx)(d.default,{left:(0,t.jsx)("button",{onClick:()=>e.push("/"),"aria-label":"홈으로",children:(0,t.jsx)(h.BackIcon,{size:20})}),title:"부적 선물"}),(0,t.jsx)("div",{className:"mx-auto flex w-full max-w-md flex-1 flex-col items-center px-5 pb-16",children:u&&p?(0,t.jsx)(i.AnimatePresence,{mode:"wait",children:"wrapped"===k?(0,t.jsxs)(l.motion.div,{initial:{opacity:0,y:24},animate:{opacity:1,y:0},exit:{opacity:0,scale:1.06,rotate:1.5},transition:{duration:.45},className:"flex w-full flex-col items-center pt-8",children:[(0,t.jsx)("p",{className:"mb-6 text-center font-serif-kr text-sm leading-relaxed text-[var(--color-galsaek)]",children:u.f?(0,t.jsxs)(t.Fragment,{children:[(0,t.jsx)("span",{className:"font-bold text-[var(--color-meok)]",children:u.f}),"님이 당신을 위해",(0,t.jsx)("br",{}),"부적을 보냈어요"]}):(0,t.jsxs)(t.Fragment,{children:["누군가가 당신을 위해",(0,t.jsx)("br",{}),"부적을 보냈어요"]})}),(0,t.jsxs)(l.motion.button,{onClick:()=>m("opened"),whileTap:{scale:.96},animate:{y:[0,-6,0]},transition:{repeat:1/0,duration:2.4,ease:"easeInOut"},className:"relative flex h-[300px] w-[230px] flex-col items-center justify-center rounded-xl",style:{background:"linear-gradient(160deg, #B93A32 0%, #A72B21 55%, #8E241C 100%)",boxShadow:"0 6px 24px rgba(122,74,52,0.35), inset 0 0 0 1px rgba(242,230,204,0.35)"},"aria-label":"선물 열어보기",children:[(0,t.jsx)("span",{className:"pointer-events-none absolute inset-3 rounded-lg",style:{border:"1px dashed rgba(242,230,204,0.5)"}}),(0,t.jsx)(h.CornerMotif,{className:"absolute left-4 top-4 text-[#F2E6CC] opacity-60",size:22}),(0,t.jsx)(h.CornerMotif,{className:"absolute right-4 top-4 rotate-90 text-[#F2E6CC] opacity-60",size:22}),(0,t.jsx)(h.CornerMotif,{className:"absolute bottom-4 left-4 -rotate-90 text-[#F2E6CC] opacity-60",size:22}),(0,t.jsx)(h.CornerMotif,{className:"absolute bottom-4 right-4 rotate-180 text-[#F2E6CC] opacity-60",size:22}),(0,t.jsx)(h.KnotMotif,{size:64,className:"text-[#F2E6CC]"}),(0,t.jsx)("span",{className:"mt-4 font-serif-kr text-lg font-bold tracking-widest text-[#F6EDD9]",children:"福"})]}),(0,t.jsx)(l.motion.p,{animate:{opacity:[.5,1,.5]},transition:{repeat:1/0,duration:2},className:"mt-6 text-xs text-[var(--color-galsaek)]",children:"살짝 눌러 보자기를 풀어보세요"})]},"wrapped"):(0,t.jsxs)(l.motion.div,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.4},className:"flex w-full flex-col items-center pt-2",children:[(0,t.jsx)(l.motion.div,{initial:{opacity:0,scale:.8,y:20},animate:{opacity:1,scale:1,y:0},transition:{delay:.15,duration:.7,type:"spring",damping:16},className:"mb-5 w-[220px] overflow-hidden rounded-lg",style:{aspectRatio:"360 / 560",boxShadow:"0 0 40px rgba(232,195,106,0.5), 0 4px 16px rgba(122,74,52,0.25)"},dangerouslySetInnerHTML:{__html:b}}),(0,t.jsxs)(l.motion.div,{initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{delay:.6},className:"mb-5 w-full text-center",children:[(0,t.jsxs)("h2",{className:"font-serif-kr text-xl font-bold text-[var(--color-meok)]",children:["「",p.name,"」",(0,t.jsx)("span",{className:"ml-1.5 text-sm font-normal text-[var(--color-galsaek)]",children:p.hanja})]}),(0,t.jsx)("p",{className:"mx-auto mt-2 max-w-xs text-sm leading-relaxed text-[var(--color-galsaek)]",children:p.description}),(u.m||u.f)&&(0,t.jsxs)("div",{className:"mx-auto mt-4 max-w-xs rounded-lg px-4 py-3",style:{border:"1px solid rgba(122,74,52,0.35)",backgroundColor:"rgba(246,237,217,0.8)"},children:[u.m&&(0,t.jsxs)("p",{className:"font-serif-kr text-sm leading-relaxed text-[var(--color-meok)]",children:["“",u.m,"”"]}),u.f&&(0,t.jsxs)("p",{className:"mt-1.5 text-[11px] text-[var(--color-galsaek)] opacity-80",children:["보낸 이: ",u.f]})]}),(0,t.jsx)("div",{className:"mt-4 flex justify-center text-[var(--color-meok)] opacity-50",children:(0,t.jsx)(h.BrushStroke,{width:90})})]}),(0,t.jsxs)(l.motion.div,{initial:{opacity:0,y:12},animate:{opacity:1,y:0},transition:{delay:.9},className:"flex w-full max-w-xs flex-col gap-3",children:[A?(0,t.jsx)("div",{className:"w-full rounded-lg py-3.5 text-center font-serif-kr text-base font-bold text-[var(--color-ssuk)]",style:{border:"1px solid rgba(107,125,99,0.5)"},children:"이미 간직한 부적이에요"}):y?(0,t.jsx)("div",{className:"w-full rounded-lg py-3.5 text-center font-serif-kr text-base font-bold text-[var(--color-ssuk)]",style:{border:"1px solid rgba(107,125,99,0.5)"},children:"✓ 부적함에 간직했어요"}):(0,t.jsx)(f.default,{onClick:()=>{if(!u||!p||A||y)return;let e={...p,id:g,savedAt:new Date().toISOString(),note:u.m||void 0,svg:b,source:"gift",fromName:u.f||void 0};try{let t=JSON.parse(localStorage.getItem("bujeok-collection")||"[]");if(t.some(e=>e.id===g))return void C(!0);t.unshift(e),localStorage.setItem("bujeok-collection",JSON.stringify(t)),w(!0)}catch{}},children:"내 부적함에 간직하기"}),(0,t.jsx)(f.default,{variant:"ghost",onClick:()=>e.push("/talisman"),children:"나도 부적 보내기"})]})]},"opened")}):(0,t.jsxs)(l.motion.div,{initial:{opacity:0,y:16},animate:{opacity:1,y:0},className:"flex flex-col items-center pt-16 text-center",children:[(0,t.jsx)(h.KnotMotif,{size:56,className:"mb-4 text-[var(--color-galsaek)] opacity-50"}),(0,t.jsx)("p",{className:"font-serif-kr text-base font-bold text-[var(--color-meok)]",children:"선물 보자기가 풀려 있어요"}),(0,t.jsxs)("p",{className:"mt-2 max-w-[240px] text-xs leading-relaxed text-[var(--color-galsaek)]",children:["링크가 잘못되었거나 오래된 선물이에요.",(0,t.jsx)("br",{}),"대신, 소중한 사람에게 보낼 부적을",(0,t.jsx)("br",{}),"직접 만들어 보는 건 어떨까요?"]}),(0,t.jsx)("div",{className:"mt-6 w-full max-w-[220px]",children:(0,t.jsx)(f.default,{onClick:()=>e.push("/talisman"),children:"나만의 부적 만들기"})})]})})]})}e.s(["default",0,function(){return(0,t.jsx)(r.Suspense,{fallback:null,children:(0,t.jsx)(x,{})})}])}]);